...
export default function Footer() {
  ...
  return (
    <footer className="bg-black text-zinc-400 py-10 border-t border-white/10 font-sans text-sm" loading="lazy">
      <div className="container mx-auto px-6 flex flex-col items-center justify-center gap-8 text-center">
        <div className="flex flex-col items-center gap-4">
          <div className="brightness-0 invert opacity-80 w-20 flex justify-center items-center"> 
             <Logo /> 
          </div>
          <p className="text-zinc-600 text-xs max-w-md">
            Un espacio para hacer lo que más te gusta: jugar.
            <br/> 
            CuartoCuarto.
          </p>
        </div>
        ...
        <div className="flex flex-col items-center gap-1 mt-6">
          <div className="text-zinc-600 text-[11px]">
            Desarrollado por <span className="text-zinc-400 font-medium">Emilio Zalva</span>
          </div>
          <a 
            href="mailto:emizalva08@gmail.com" 
            className="text-zinc-600 hover:text-orange-500 transition-colors text-[10px]"
          >
            emizalva08@gmail.com
          </a>
        </div>
